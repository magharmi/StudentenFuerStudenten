    ...
    <div id="KursBeigetreten">
        <div class="w3-row-padding w3-margin-top">
            <div class="w3-half">
                <div class="w3-card w3-container">
                    <div id="KursZusammenfassung">
                        <h2>Kurs:</h2>
                        <h4 id="KursTitel">C Programmierung</h4>
                        <p> </p>
            ...
            <div class="w3-half">
                <div class="w3-card w3-container">
                    <h1>Beschreibung</h1>
                    <p id="KursBeschreibung">C ist eine imperative und prozedurale Programmiersprache, die der Informatiker Dennis Ritchie in den fr&uumlahen 1970er Jahren an den Bell Laboratories entwickelte. Seitdem ist sie eine der am weitesten verbreiteten Programmiersprache.</p>
                </div>
            </div>
            <div class="w3-col">
